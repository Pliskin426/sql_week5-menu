...
public class TeamDao {
	...
	private final String CREATE_NEW_TEAM_QUERY = "INSERT INTO teams(team_name) VALUES(?)";
	...
	public void deleteTeamById(int id) throws SQLException {
		heroDao.deleteHerosByTeamId(id);
	...
	private Team populateTeam(int id, String name) throws SQLException {
		return new Team(id, name, heroDao.getMembersByTeamId(id));
	}
